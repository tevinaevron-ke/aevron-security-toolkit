Day 1 -  May 2026.LinkedIn Live. First product on Gumroad. First security audit completed.Aevron Security is open for business.         
Day 2 —  May 2026. Completed TryHackMe What is Networking room. Started Kali Linux lab setup. Agency audit rewritten. Medium article skeleton drafted.
Day 3 —   May 2026. Audit finalized with Executive Summary. Medium article drafted. mpesa_validator.py committed. Post 3 live.
Day 4 -  May 2026. Completed TryHackMe network module.Final touches of the agency done.Approach to local business started.
Day 5-  June 2026 .Cache: A local "cheat sheet" that saves website addresses to speed up future visits.
...
Day 6  June 2026:URL Structure: Parsed components including Scheme, Host, Port (1-65535), Path, and Query Strings.
